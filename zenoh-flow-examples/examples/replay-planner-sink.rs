...
use zenoh_flow::{
    ...
    zf_empty_state, ZFResult, get_input
};

#[derive(Serialize, Deserialize, Debug, ZFState)]
struct ReplayPlannerSink {}

impl ReplayPlannerSink {
    ...
    pub async fn run_1(_ctx: ZFContext, inputs: ZFInput) -> ZFResult<()> {
        println!("zenoh-flow end");
        Ok(())
    }
}

impl SinkTrait for ReplayPlannerSink {
...
extern "C" fn register(
    ...
    Ok(Box::new(ReplayPlannerSink {}) as Box<dyn zenoh_flow::SinkTrait + Send>)
}
